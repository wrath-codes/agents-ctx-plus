...
> Compressed context index for 254 files across 16 sections. Follows the Vercel AGENTS.md passive context pattern for retrieval-led reasoning.
...
|---|:---:|---|---|
|axum|13|[INDEX.md](axum/INDEX.md)|Rust web framework on Tower/Hyper — routing, extractors, middleware, WebSockets, SSE|
| | |↳ [core](axum/core/) · [middleware](axum/middleware/) · [advanced](axum/advanced/) · [extras](axum/extras/)| |
|beads|21|[INDEX.md](beads/INDEX.md)|Git-backed issue tracking — 3-layer arch (Git/JSONL/SQLite), workflows, multi-agent|
...
|btcab|8|[INDEX.md](btcab/INDEX.md)|Beads alternative — CLI task management with MCP integration|
...
|clap|15|[INDEX.md](clap/INDEX.md)|Rust CLI parser — derive macros, builder API, subcommands, validation|
...
|document-store|11|[INDEX.md](document-store/INDEX.md)|Linear-hash document storage — WARC/CDX formats, GraphQL query engine|
...
|fastembed|4|[INDEX.md](fastembed/INDEX.md)|Rust embedding models — ONNX runtime, text/image embeddings|
...
|llm-context-management|27|[INDEX.md](llm-context-management/INDEX.md)|Context management research — observation masking, summarization, hybrid, PLENA, safety|
...
|rig|17|[INDEX.md](rig/INDEX.md)|LLM agent framework — providers, tools, RAG, vector stores (7 backends)|
...
|tokio|26|[INDEX.md](tokio/INDEX.md)|Async runtime — tasks, I/O, networking, sync, channels, select, streams|
| | |↳ [concepts](tokio/concepts/) · [tutorial](tokio/tutorial/) · [rust-api](tokio/rust-api/) · [topics](tokio/topics/) · [ecosystem](tokio/ecosystem/)| |
|tonic|12|[INDEX.md](tonic/INDEX.md)|gRPC framework — protobuf codegen, server/client, streaming, TLS|
| | |↳ [getting-started](tonic/getting-started/) · [core](tonic/core/) · [streaming](tonic/streaming/) · [advanced](tonic/advanced/)| |
|tower|14|[INDEX.md](tower/INDEX.md)|Service middleware — Service/Layer traits, timeout, retry, rate-limit, tower-http|
| | |↳ [core](tower/core/) · [middleware](tower/middleware/) · [patterns](tower/patterns/) · [tower-http](tower/tower-http/)| |
|tree-sitter|16|[INDEX.md](tree-sitter/INDEX.md)|Incremental parser — grammar DSL, query language, Rust API, multi-language|
...
|turso|35|[INDEX.md](turso/INDEX.md)|SQLite platform — libSQL, embedded replicas, AgentFS, SDKs (6 languages), cloud|
...
---
*254 files · 16 sections · Last indexed: 2026-02-06*
